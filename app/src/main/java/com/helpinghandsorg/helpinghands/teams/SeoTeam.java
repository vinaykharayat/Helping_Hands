...
public class SeoTeam extends Fragment implements UsersListAdaptor.OnUserListClickListner{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference appTeamRef = FirebaseDatabase.getInstance().getReference("Volunteer").child("SeoTeam");
