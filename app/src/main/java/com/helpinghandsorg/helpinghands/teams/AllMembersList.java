...
public class AllMembersList extends Fragment implements UsersListAdaptor.OnUserListClickListner {
    ...
    private void readData(final FirebaseCallBack firebaseCallback) {
        DatabaseReference appTeamRef = FirebaseDatabase.getInstance().getReference("Volunteer").child("Member");
    ...
    public void onUserListClick(final int position) {
        if (!volunteerArrayList.get(position).getId().equals(adminStatus)) {
